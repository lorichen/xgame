...
///////////////////////////////////////////////////////////////////////////////
// ctor
CMiniVersion::CMiniVersion(const char* lpszPath)
{
...
bool CMiniVersion::Init()
{
	...
	dwSize = ::GetFileVersionInfoSize((LPSTR)(const char*)m_szPath, &dwHandle);
	if (dwSize == 0)
		return FALSE;
	...
	rc = ::GetFileVersionInfo((LPSTR)(const char*)m_szPath, dwHandle, dwSize, m_pData);
	if (!rc)
		return FALSE;
