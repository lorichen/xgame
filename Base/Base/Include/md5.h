...
//
RKT_EXPORT char * GetMD5Hash(char szHashOut[33], const unsigned char *pBufIn, DWORD nInSize);
RKT_EXPORT unsigned char * GetMd5HashHex(char* buf , DWORD  buflen,unsigned char* outputmd5);
