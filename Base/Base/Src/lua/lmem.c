...
// modified by pk --start
#include "Config.h"
#ifdef MEMORY_DEBUG
#	define FILE_LINE_ARGS	,const char* f,int l
#	define FILE_LINE_PARAM	,__FILE__,__LINE__
#else
...
#ifndef l_realloc
extern void* mem_realloc(void* p, size_t s FILE_LINE_ARGS);
#	define l_realloc(b,os,s)	mem_realloc(b, s FILE_LINE_PARAM)
#endif

#ifndef l_free
/*__declspec(dllimport)*/extern void mem_free(void* p FILE_LINE_ARGS);
#	define l_free(b,os)			mem_free(b FILE_LINE_PARAM)
#endif
// modified by pk --end
