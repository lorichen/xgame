...
#define _RenderEngineExport __declspec(dllexport)
#else
#define _RenderEngineExport// __declspec(dllimport)
#endif

#ifndef RENDERENGINE_EXPORTS
#ifdef _DEBUG
#pragma comment(lib, "xs_render_d.lib")
#elif RELEASEDEBUG
#pragma comment(lib, "xs_render_rd.lib")
#else
#pragma comment(lib, "xs_render.lib")
#endif
#endif