    ...
    */
    ...
    public:
        ...
        */
        ...
        _ReMathExport friend Vector3 operator* (const Vector3& rkVector,
        ...
        // scalar * matrix
        _ReMathExport friend Matrix3 operator* (float fScalar, const Matrix3& rkMatrix);
        ...
        inline void ToAxisAngle (Vector3& rkAxis, float& rfRadians) const {
			Radian r;
			ToAxisAngle ( rkAxis, r );
			rfRadians = r.valueRadians();
		}
        inline void FromAxisAngle (const Vector3& rkAxis, float fRadians) {
