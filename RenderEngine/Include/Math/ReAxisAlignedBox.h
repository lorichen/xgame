    ...
    */
    ...
    public:
	    ...
	    */
	    ...
	    /** Returns a pointer to an array of 8 corner points, useful for
		    ...
		    @remarks
			    ...
			    because rkt uses right-handed coordinates, the minimum Z is
	    ...
	    */
	    ...
	    friend std::ostream& operator<<( std::ostream& o, AABB aab )
	    {
		    if (aab.isNull())
		    {
			    o << "AABB(null)";
	    ...
	    */
		...
		void fromVertices(const Vector3* pVertices,uint num)
		{
