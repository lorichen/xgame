...
class FTCharmap
{
    public:
         ...
         *              if it wasn't found
         */
        uint GlyphListIndex( const uint characterCode);
         ...
         */
        uint FontIndex( const uint characterCode);
         ...
         *                       character code.
         */
        void  InsertIndex( const uint characterCode, const uint containerIndex);
