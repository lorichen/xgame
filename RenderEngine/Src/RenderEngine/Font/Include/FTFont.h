...
/**
 * FTFont is the public interface for the FT library.
 *
 ...
 * code returned. <code>FT_Error Error_()</code>. Check the freetype file fterrdef.h
...
class FTFont
{
    public:
         ...
         * The buffer is owned by the client and is NOT copied by FT. The
         * pointer must be valid while using FT.
         *
         * @param pBufferBytes  the in-memory buffer
         * @param bufferSizeInBytes  the length of the buffer in bytes
         */
        FTFont( const uchar*pBufferBytes, size_t bufferSizeInBytes);
        ...
        /**
         * Enable or disable the use of Display Lists inside FT
         *
		...
		/**
		 * Set the render direction of text
		 * return the old render direction
		*/
		FontRenderDirection setRenderDirection( FontRenderDirection rd);

		/**
		 * Set the font gap between adjacent words
		 * return the old gap
		*/
		float setFontGap( float gap);
    ...
    protected:
         ...
         */
        virtual FTGlyph* MakeGlyph( uint g) = 0;
        ...
        /**
         * Flag to enable or disable the use of Display Lists inside FT
    ...
    private:        
         ...
         */
        inline bool CheckGlyph( const uint chr);
