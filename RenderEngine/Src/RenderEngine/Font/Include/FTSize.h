...
class FTSize
{
    public:
         ...
         * @return          <code>true</code> if the size has been set. Clients should check Error_() for more information if this function returns false()
         */
        bool CharSize( FT_Face* face, uint point_size, uint x_resolution, uint y_resolution);
