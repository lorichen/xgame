 ...
 *     "b7 b6 b5 b4 b3 b2 b1 b0," where b0 indicates the uchar that
 *     was lowest in memory (e.g., corresponding to a left pixel)
 *     and b7 is the uchar that was highest (e.g., a right pixel).
 *
 * 19991016:
...
// GRR TEST:  should work, but needs testing (special 64-bit version of rpng2?)
                  ...
                  if (((pass == 0) || (pass == 1)) && width)
                  {
                     ...
                     // source is 8-uchar RRGGBBAA
                     // dest is 64-uchar RRGGBBAA RRGGBBAA RRGGBBAA RRGGBBAA ...
                     __asm__ __volatile__ (
                        "subl $56, %%edi         \n\t" // start of last block
                  ...
                  {
                     // source is 8-uchar RRGGBBAA
                     // dest is 32-uchar RRGGBBAA RRGGBBAA RRGGBBAA RRGGBBAA
                  ...
                  {
                     // source is 8-uchar RRGGBBAA
                     // dest is 16-uchar RRGGBBAA RRGGBBAA
                     {
                        int dummy_value_c;  // fix 'forbidden register spilled'
                        int dummy_value_S;
                        int dummy_value_D;
...
// preload  "movl prev_row, %%esi         \n\t" // esi:  Prior(x)
         ...
         "avg_3lp:                        \n\t"
            ...
            "movq %%mm7, %%mm6            \n\t"
            "pand %%mm1, %%mm3            \n\t" // get lsb for each prev_row uchar
...
// preload  "movl prev_row, %%esi        \n\t" // esi:  Prior(x)
         ...
         "avg_8lp:                       \n\t"
            ...
            "pand %%mm2, %%mm3           \n\t" // get LBCarrys for each uchar
                                               //  where both lsb's were == 1
            "psrlq $1, %%mm2             \n\t" // divide raw bytes by 2
            "pand  %%mm4, %%mm1          \n\t" // clear invalid bit 7, each uchar
            "paddb %%mm3, %%mm0          \n\t" // add LBCarrys to Avg, each uchar
            "pand  %%mm4, %%mm2          \n\t" // clear invalid bit 7, each uchar
...
//pre "movl len, %%edx              \n\t"
   ...
   "up_lt8:                         \n\t"
      "xorl %%eax, %%eax            \n\t"
      "addl %%edx, %%ecx            \n\t" // move over uchar count into counter
...
//      "popf                 \n\t"  // 16-bit popf
        ...
        "xorl %%eax, %%eax    \n\t"  // set eax to zero
//      ".uchar  0x0f, 0xa2    \n\t"  // CPUID instruction (two-uchar opcode)
