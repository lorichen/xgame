...
/**
	这里的事件定义只是一个子集，忽略了一些与游戏无关的鼠标和键盘事件
*/

/// 消息范畴
enum MsgCategory
{ 
	MsgCategoryMouse = 0x1,		/// 鼠标消息类
	MsgCategoryKey = 0x2,		/// 键盘消息类
	MsgCategoryNet = 0x4,		/// 网络消息类
...
{
	uint syskeys;		/// 系统按键
	uint vkcode;		/// 键码(兼容win32)
	Key::Scan scancode;	/// 本系统定义的键码(兼容cegui)
};
