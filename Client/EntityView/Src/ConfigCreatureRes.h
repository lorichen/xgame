...
public:
	...
	typedef stdext::hash_map<std::string,int,stdext::hash_compare<std::string,lessString> > IdMap;
	IdMap m_idMaps;
	typedef stdext::hash_map<int,std::string> ResMap;
	ResMap m_resMap;
    ...
    // 通过资源ID来查找对应的声音ID；
	typedef stdext::hash_map<int,IDName> IdSoundMap;
